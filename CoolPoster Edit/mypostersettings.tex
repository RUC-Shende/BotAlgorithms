...
\newAlert{MainTopic}{Figures}{
                     \begin{center}
                         ...
                         \end{subfigure}
%                         \includegraphics[width=3in]{mypics/2Q1S_Initial.png}\hspace{1cm}\includegraphics[width=3in]{mypics/2Q1S_Initial.png}\hspace{1cm}  \\[.2cm]
%                         \captione{3in}{Inital Steps}
%                         \includegraphics[width=3in]{mypics/2Q1S_Secondary.png}\hspace{1cm}\includegraphics[width=3in]{mypics/2Q1S_Secondary.png}\hspace{1cm}  \\[.2cm]

...
\newblock{Definitions}{Definitions}{
         A  \textbf{distinguished} bot is one that ends the algorithm, when it reaches the exit.
         A \textbf{helper} bot is one that helps distinguished find the exit.
         An \textbf{exit} is a point unknown to the algorithm, that is located on an edge.
         The exit is \textbf{found} if a bot's coordinates match the exit locations.
         The algorithm \textbf{terminates} if a specified subset of bots shares a position with the exit.
         }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newblock{Description}{Algorithm Description}{
	A distinguished and helper bot move together at some $\alpha$ below the negative x axis, where then the helper travels clockwise, and the distinguished counter. The other distinguished travels along the positive x axis, where it then travels counter clockwise.
         }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

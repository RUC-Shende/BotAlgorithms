...
\newblock{Conclusions}{Conclusions}{
	This algorithm has an upper bound of 3.55 time units, being faster than an algorithm of one distinguished and two helpers with an upper bound of 3.83 time units.
             \begin{center}
...
\newAlert{MainProblem}{Main Result}{
            ...
            3 agents, nor does it represent all algorithms using distinguished agents.
             \begin{center}
                 \includegraphics[width=5in]{mypics/temp.JPG}\\[.2cm]
                 \captione{5in}{Temp 1}
             \end{center}
            }

\newAlert{Conjectures}{Our Conjectures and Analysis}{
            \indent In this algorithm, we observe two worst case situations. In one, the priority
            ...
            agent would have to travel along a chord to reach it (Fig. 4 above). \newline
            \indent We analyze the case in which the helper agent finds the exit in the second quadrant.
            ...
            bottom part of the circle, which is $\[ 1 + \gamma$, where $\gamma$ is a distance traveled by the priority agent such that
            it finds the exit a small distance before angle 0.
            }
